...
class multiResultClass():
    ...
    def __init__(self, index, x_tau, Y , BIC10, BICpq, order, persistence, AR1coeff):
        self.index = index
        self.x_tau = x_tau
        self.Y = Y
        self.BIC10 = BIC10
...
def Y_ARIMA_i(time_series, tau, p_max, q_max, i,wind_shift):
    ...
    results = multiResultClass(None, None, None, None, None, None, None, None)
    #save i
    results.index = i
