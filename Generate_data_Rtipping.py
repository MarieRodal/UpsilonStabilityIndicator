# -*- coding: utf-8 -*-
"""
Created on Fri Oct  8 10:05:25 2021

@author: Marie
"""

#generate data for phase plane analysis, time dependent H non-zero Tris and Tfall
...
def global_oceanic_3box_model(X,t):
    ...
    def H(t, H0 = 0, Hpert = 0.37, Tris = 100, Tpert  = 400, Tfall = T_fall):
        T0 = 100
        ...
        elif (t>(Tris+T0) and t<=(T0+Tris+Tpert)):
            output = Hpert;
        elif (t>(T0+Tris+Tpert) and t<=(T0+Tris+Tpert+Tfall)):
            output = rfall * t + (Hpert - (rfall *(T0+Tris+Tpert))) # linear 
        elif t>(T0+Tris+Tpert+Tfall):
            output = H0
